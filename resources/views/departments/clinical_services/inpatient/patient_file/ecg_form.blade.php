                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div id="printableArea{{$i}}">
                                                        <h2>VIEW E.C.G REQUEST FORM</h2>
                                                        <p><b>PATIENT NAME : </b>{{$patient->name}}</p>
                                                        <p><b>DATE : </b>{{$eeg_report_result->bio_date}}</p>
                                                        <p><b>WARD : </b>{{$eeg_report_result->bio_ward}}</p>
                                                        <p><b>BED NUMBER : </b>{{$eeg_report_result->bio_bed_number}}</p>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="container-fluid">
                                            <form action="{{route('ecg_form_post',['patient_id'=>$patient_id])}}" method="post" >{!! csrf_field() !!}
                                                        ...
                                                        <div class="offset-md-6">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <input type="date" id="myDate1" name="date" readonly class="form-control">
                                                                </div>
                                                                <div class="form-group col-md-4">
