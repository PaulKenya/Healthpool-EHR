        ...
        <div class="col-sm-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>OCCUPATIONAL THERAPY INITIAL ASSESSMENT VIEWS</h4>
                </div>
                <div class="card-body">
                ...
                <div class="modal fade" id="myModal" role="dialog">
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <form action="{{route('patient_file_occupational_therapy_initial_assessment__post',['patient_id'=>$patient_id])}}" method="post" >{!! csrf_field() !!}
