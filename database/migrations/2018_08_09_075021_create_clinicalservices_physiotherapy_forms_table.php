...
class CreateClinicalservicesPhysiotherapyFormsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clinicalservices_physiotherapy_forms', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('clinicalservices_physiotherapy_forms');
    }
}
